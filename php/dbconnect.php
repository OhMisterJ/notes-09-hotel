...
/* Before we can start storing data, we need a table to hold the data first. The code below, uses PHP and SQL to dynamically create our database table and table values. */
